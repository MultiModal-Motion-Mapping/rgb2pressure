...
class config_cont():
    ...
    def __init__(self):
        ...
        self.cfg.dataset.vector = '' # 添加自MI 1353140938@qq,com
        
        self.cfg.networks = CN()
        self.cfg.networks.vec_module = ''
        self.cfg.networks.vec_path = ''
        self.cfg.networks.FP_module = ''
        self.cfg.networks.FP_path = ''
        self.cfg.networks.seqlen = 5
        self.cfg.networks.model = ''
